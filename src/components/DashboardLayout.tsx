          ...
          {activeTab === 'settings' && (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Lead Generation Configuration</h3>
                    <p className="text-sm text-gray-600">
                      Configure real data sources for dental clinic lead generation
                    </p>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="flex items-center text-green-600">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-blue-800 mb-2">
                    🚀 Enable Multi-Source Real Lead Generation
                  </h4>
                  <div className="text-sm text-blue-700 space-y-3 mb-4">
                    <div>
                      <strong>Option 1: OpenStreetMap (100% Free)</strong>
                      <div className="ml-4 mt-1 text-green-700">
                        ✅ Already enabled! No API key required - uses community-maintained data
                      </div>
                    </div>

                    <div>
                      <strong>Option 2: Google Places API (Premium)</strong>
                      <div className="ml-4 mt-1 space-y-1">
                        <div>1. Get API key from <a href="https://console.cloud.google.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Google Cloud Console</a></div>
                        <div>2. Enable Places API and Geocoding API</div>
                        <div>3. Add to .env: <code className="bg-blue-100 px-1 rounded">GOOGLE_PLACES_API_KEY=your_key</code></div>
                      </div>
                    </div>

                    <div>
                      <strong>Option 3: Foursquare Places (Free Tier)</strong>
                      <div className="ml-4 mt-1 space-y-1">
                        <div>1. Get free API key from <a href="https://developer.foursquare.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Foursquare Developer</a></div>
                        <div>2. Add to .env: <code className="bg-blue-100 px-1 rounded">FOURSQUARE_API_KEY=your_key</code></div>
                      </div>
                    </div>
                  </div>

                  <div className="bg-yellow-50 border border-yellow-200 rounded p-3 text-sm text-yellow-800 mb-4">
                    <strong>💡 Pro Tip:</strong> Configure multiple data sources for maximum coverage! The system automatically aggregates and deduplicates data from all available sources.
                  </div>

                  <div className="text-sm text-blue-700">
                    <strong>🔄 After configuration:</strong> Restart your application to activate the new data sources.
                  </div>
                </div>
                ...
                <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-green-700 space-y-1">
                    <div>• <strong>Accurate Contact Information:</strong> Real phone numbers, addresses, and websites</div>
                    <div>• <strong>Business Verification:</strong> Only active, legitimate dental practices</div>
                    <div>• <strong>Current Data:</strong> Up-to-date information from Google&apos;s database</div>
                    <div>• <strong>Rich Details:</strong> Business hours, ratings, and specialty information</div>
                    <div>• <strong>Location Precision:</strong> Accurate geographical targeting</div>
                  </div>
                </div>
              </div>
            </div>
